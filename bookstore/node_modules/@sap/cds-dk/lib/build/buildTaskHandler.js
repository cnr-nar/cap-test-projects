...
const { OUTPUT_MODE, OUTPUT_MODE_FILESYSTEM, SEVERITY_INFO, SEVERITY_WARNING, SEVERITY_ERROR, OVERRIDE_METHOD_MSG } = require('./constants')
...
class BuildTaskHandler {
    ...
    async model() {
        ...
        this._logger._debug && this._logger.debug(`model: ${relativePaths(cds.root, files).join(", ")}`)
