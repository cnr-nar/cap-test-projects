module.exports = Object.assign(build, {
    options: ['--project', '--src', '--dest', '--for', '--use', '--opts', '--log-level', '--options-model', '--clean'],
    shortcuts: ['-in', '-s', '-o', '-4'],
    help: `
# SYNOPSIS
...
async function build([project], options = {}) {
    ...
    if (options.clean === "false") {
        throw "cds build option '--clean' is deprecated - build output folders are always cleaned before build"
    }
